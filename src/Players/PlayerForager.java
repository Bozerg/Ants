...
//I know I'm good at this because my code has more flags than the U.N...
public class PlayerForager extends Player {

    public PlayerForager(Color color, int playerNumber, int turnTime, String name) {
        super(color, playerNumber, turnTime, name);
    }

    public PlayerForager(Color color, int playerNumber, int turnTime) {
        super(color, playerNumber, turnTime, "Forager");
    }
